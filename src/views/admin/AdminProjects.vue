<template>
    ...
    <div class="container mx-auto p-4 font-roboto">
        <h2 ref="tableTopPosition" class="text-3xl font-bold mb-6 text-center">Projects</h2>
                    ...
                    <tr v-for="project in paginatedProjects" :key="project.id"
                        ...
                        <td class="py-4 px-4 relative group">
                            <img :src="project.imageUrl" alt="project image"
                                class="h-16 w-16 object-cover rounded-md border-2 border-gray-200 shadow-md" />
                            <div
                                class="absolute top-0 left-0 hidden group-hover:block bg-white border border-gray-300 p-1 z-10 rounded-md shadow-md">
                                <img :src="project.imageUrl" alt="project image" class="h-auto w-auto object-cover" />
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <div class="relative group">
                                <span class="truncate block max-w-xs">
                                    {{ project.features.length > 0 ? project.features[0].description.slice(0, 30) +
    ...
    <div class="container mx-auto mt-8 font-roboto">
        <div class="md:w-1/2 mx-auto">
            <form @submit.prevent="saveProject" class="bg-white shadow-lg rounded-lg p-8">
                <h2 class="text-2xl font-bold mb-6 text-center"> Add new project
                </h2>
                <div class="mb-4">
                ...
                <div class="text-center">
                    ...
                    <p v-if="serverError" class="text-red-500 text-xs italic mt-2">{{ serverError }}</p>
