<template>
    ...
    <div class="container mx-auto p-4 font-roboto">
        <h2 ref="tableTopPosition" class="text-2xl font-bold mb-4">PRODUCTS</h2>
                    ...
                    <tr v-for="product in paginatedProducts" :key="product.id"
                        ...
                        <td class="py-3 px-4 border-b relative group">
                            ...
                            <div
                                ...
                                <img :src="product.imageUrl" alt="product image" class="h-auto w-auto object-cover" />
                            </div>
                        </td>
