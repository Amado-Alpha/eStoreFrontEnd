<template>
    ...
    <div class="container mx-auto p-4 font-roboto">
        <h2 ref="tableTopPosition" class="text-2xl font-bold mb-4">TESTIMONIALS</h2>
            ...
            <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden text-left rtl:text-right">
                ...
                <tbody>
                    ...
                    <tr v-for="testimonial in paginatedTestimonials" :key="testimonial.id"
                        ...
                        <td class="py-3 px-4 border-b">{{ testimonial.authorFirstname }}</td>
                        <td class="py-3 px-4 border-b">{{ testimonial.authorSurname }}</td>
                        ...
                        <td class="py-3 px-4 border-b relative group">
                            <img :src="testimonial.imageUrl" alt="testimonial image" class="h-16 w-16 object-cover" />
                            <div
                        ...
                        <td class="py-3 px-4 border-b">{{ testimonial.price }}</td>
                        <td class="py-3 px-4 border-b">{{ testimonial.price }}</td>
                        <td class="py-3 px-4 border-b">
    ...
    try {
        ...
        if (imageUrlFromCloudinary) {
            const testimonial = {
                ...
                description: testimonialStatement.value,
                price: rating.value,
            ...
            //Adding testimonial to the state
            await store.dispatch('testimonials/addProduct', testimonial);
        }
    } catch (error) {
        console.error(error);
    }
